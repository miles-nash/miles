  ...
  return (
    <div className="flex min-h-screen bg-white text-black font-sans">
      ...
      <aside className="w-64 min-h-screen px-8 py-12 bg-white fixed left-0 top-0 flex flex-col items-start">
        ...
        <nav className="flex flex-col gap-14 text-[2.75rem] font-normal leading-none">
      ...
      {/* Main Content */}
      <main className="flex-1 ml-64 flex flex-col items-center justify-start py-20">
        <div className="w-1/2 mx-auto flex flex-col items-center mt-16 gap-16">
          ...
          {/* Boxed Quote */}
          <div className="border border-neutral-700 rounded-sm p-8 mb-12 w-full bg-white">
            <pre className="font-mono text-lg text-neutral-800 whitespace-pre-wrap text-center">"The faster ideas leave your head,\n    the faster they evolve."</pre>
          </div>
          ...
          <div className="w-full flex justify-center mt-8">
            <span className="font-mono text-lg text-neutral-600">$_ cd /projects</span>
          </div>
        </div>
      </main>
    </div>
